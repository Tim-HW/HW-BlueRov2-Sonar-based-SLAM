...
class points():
    ...
    def __init__(self):
        self.pub1 = rospy.Publisher("/tritech_micron/threshold",PointCloud,queue_size=1)               #Create a topic with the new PointCloud
        self.pub2 = rospy.Publisher("/tritech_micron/scan_3D",PointCloud,queue_size=1)               #Create a topic with the new PointCloud
        self.pub3 = rospy.Publisher("/tritech_micron/max",PointCloud,queue_size=1)               #Create a topic with the new PointCloud
    ...
    def get_data(self,var):
        ...
        self.pub3.publish(PC)  # publish it into the new topic
